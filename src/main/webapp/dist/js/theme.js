! function(e, s, i) {
    ...
    i(s).ready(function() {
        function a(e, s) {
            e.children(".submenu-content").show().slideUp(400, function() {
        ...
        t.on("click", ".navigation-main .nav-item a", function() {
            ...
            if (e.hasClass("has-sub") && e.hasClass("open")) a(e);
                ...
                if (e.hasClass("has-sub") && function(e, s) {
                        ...
                        e.addClass("open"), a.hide().slideDown(400, function() {
            ...
            if (l.hasClass("nav-collapsed")) {
                ...
                s.addClass("nav-collapsed-open"), a.show().slideUp(400, function() {
                    i(this).css("display", "")
                }), s.removeClass("open")
            }
        ...
        //     var isInsideContainer = $rightSidebar.contains( event.target ) ;
